...
namespace WebSocketManager
{
    public abstract class WebSocketHandler
    {
        ...
        public virtual async Task OnConnected(WebSocket socket)
        {
            ...
            await SendMessageAsync(socket, new Message() { MessageType = MessageType.ConnectionEvent, Data = WebSocketConnectionManager.GetId(socket) }).ConfigureAwait(false);
        }
        ...
        public virtual async Task ReceiveAsync(WebSocket socket, WebSocketReceiveResult result, Message receivedMessage)
        {
            ...
            if (receivedMessage.MessageType == MessageType.MethodInvocation)
            {
                ...
                try
                {
                    invocationDescriptor = JsonConvert.DeserializeObject<InvocationDescriptor>(JsonConvert.SerializeObject(receivedMessage.Data, _jsonSerializerSettings), _jsonSerializerSettings);
            ...
            {
                var invocationResult = JsonConvert.DeserializeObject<InvocationResult>(JsonConvert.SerializeObject(receivedMessage.Data, _jsonSerializerSettings), _jsonSerializerSettings);
